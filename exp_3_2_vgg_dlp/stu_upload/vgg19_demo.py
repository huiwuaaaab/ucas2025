...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        input_shape13[2] = 224
        input_shape13[3] = 224
        self.net.createPoolingLayer('pool1',input_shape13,2,2)
        ...
        #pool2
        input_shape23 = pycnnl.IntVector(4)
        input_shape23[0] = 1
        input_shape23[1] = 128
        input_shape23[2] = 112
        input_shape23[3] = 112
        self.net.createPoolingLayer('pool2',input_shape23,2,2)
        ...
        #pool3
        input_shape35 = pycnnl.IntVector(4)
        input_shape35[0] = 1
        input_shape35[1] = 256
        input_shape35[2] = 56
        input_shape35[3] = 56
        self.net.createPoolingLayer('pool3',input_shape35,2,2)
        ...
        #pool4
        input_shape45 = pycnnl.IntVector(4)
        input_shape45[0] = 1
        input_shape45[1] = 512
        input_shape45[2] = 28
        input_shape45[3] = 28
        self.net.createPoolingLayer('pool4',input_shape45,2,2)
        ...
        #pool5
        input_shape55 = pycnnl.IntVector(4)
        input_shape55[0] = 1
        input_shape55[1] = 512
        input_shape55[2] = 14
        input_shape55[3] = 14
        self.net.createPoolingLayer('pool5',input_shape55,2,2)
        ...
        input_shapem8 = pycnnl.IntVector(4)
        input_shapem8[0] = 1
        input_shapem8[1] = 1
        input_shapem8[2] = 1
        input_shapem8[3] = 4096
        weight_shapem8 = pycnnl.IntVector(4)
        weight_shapem8[0] = 1
        weight_shapem8[1] = 1
        weight_shapem8[2] = 4096
        weight_shapem8[3] = 1000
        output_shapem8 = pycnnl.IntVector(4)
        output_shapem8[0] = 1
        output_shapem8[1] = 1
        output_shapem8[2] = 1
        output_shapem8[3] = 1000

        self.net.createMlpLayer('fc8', input_shapem8, weight_shapem8, output_shapem8)
